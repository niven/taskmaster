...
ALTER TABLE task_assignments ADD CONSTRAINT "task_assignment_task_id_ref_task_id_fkey_del_cascade" FOREIGN KEY (task_id) REFERENCES tasks ON DELETE CASCADE;
