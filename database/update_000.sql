...
CREATE TABLE task_assignments (id SERIAL PRIMARY KEY, task_id INTEGER, minion_id INTEGER, assigned_on DATE NOT NULL, status enum_status default 'pending', CONSTRAINT task_assignment_task_id_ref_task_id_fkey FOREIGN KEY (task_id) REFERENCES task(id), CONSTRAINT task_assignment_minion_id_ref_minions_id_fkey FOREIGN KEY (minion_id) REFERENCES minions(id));
-- System data
